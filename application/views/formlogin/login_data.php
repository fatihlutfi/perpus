...
<head>
    ...
    <title>Login | Fatih-Perpus</title>
...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>FATIH Library</strong></a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4> Welcome to Management Library Application</h4><hr class="line-title"> 
